...
/** Input for the loginMutation mutation */
...
export const generatedSchema = {
  ...
  mutation: {
    ...
    loginMutation: {
      __type: 'LoginMutationPayload',
      __args: { input: 'LoginMutationInput!' },
    },
    registerUser: {
  ...
  LoginMutationPayload: {
    __typename: { __type: 'String!' },
    authorization_code: { __type: 'String' },
    clientMutationId: { __type: 'String' },
  },
  RegisterUserInput: {
    aim: { __type: 'String' },
...
/**
 * The payload for the loginMutation mutation
 */
export interface LoginMutationPayload {
  __typename: 'LoginMutationPayload' | undefined;
  /**
   * Authorization code used for requesting a refresh token
   */
  authorization_code?: Maybe<ScalarsEnums['String']>;
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums['String']>;
